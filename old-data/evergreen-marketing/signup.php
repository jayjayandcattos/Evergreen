...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (
        ...
        empty($gender_id) || empty($marital_status) || empty($occupation) || empty($monthly_salary)
    ) {
...
<body>
  <div class="left">
    ...
    <form method="POST" id="signupForm" novalidate>
      ...
      <div class="form-step active" data-step="1">
        ...
        <div class="form-row">
         ...
         <div class="input-wrapper full">
          ...
          <div class="input-wrapper full">
              <label class="input-label" for="monthly_salary">Monthly Salary <span style="color: red;">*</span></label>
              <input type="number" name="monthly_salary" id="monthly_salary" placeholder="e.g., 50000" 
                     value="<?php echo isset($_POST['monthly_salary']) ? htmlspecialchars($_POST['monthly_salary']) : ''; ?>" 
                     min="0" step="0.01" required>
              <span class="error-message" id="monthly_salary_error">Monthly salary is required</span>
          </div>
      ...
      <div class="form-step" data-step="2">
        ...
        <div class="input-wrapper full">
          <label class="input-label" for="referral_code">Referral Code (Optional)</label>
          <input type="text" name="referral_code" id="referral_code" 
                 placeholder="Enter friend's referral code (e.g., EVG000001123)" 
                 value="<?php echo isset($_POST['referral_code']) ? htmlspecialchars(strtoupper($_POST['referral_code'])) : ''; ?>"
                 style="text-transform: uppercase;">
          <span class="error-message" id="referral_code_error"></span>
          <small style="color: #666; font-size: 11px; margin-top: 4px; display: block;">
            Have a referral code? Enter it here to earn bonus points for you and your friend!
          </small>
        </div>
  ...
  <script>
    ...
    const fields = {
        ...
        monthly_salary: document.getElementById("monthly_salary"),
    ...
    const errors = {
        ...
        monthly_salary: document.getElementById("monthly_salary_error"),
    ...
    function validateStep(stepNumber) {
        ...
        if (stepNumber === 1) {
            ...
            const requiredFields1 = ['first_name', 'last_name', 'birthday', 'gender', 'marital_status', 'occupation', 'monthly_salary'];
